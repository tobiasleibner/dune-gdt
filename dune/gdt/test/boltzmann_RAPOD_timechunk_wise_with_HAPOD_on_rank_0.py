...
def rapod_timechunk_wise():
    ...
    for i in range(0, int(b.num_chunks)):
        ...
        num_modes = len(timestep_vectors)
    ...
    if b.rank_proc == 0:
        final_modes, total_num_snapshots = b.gather_on_rank_0(b.comm_rank_0_group, final_modes, total_num_snapshots, uniform_num_modes=False)
        final_modes = b.pod_and_scal(final_modes, total_num_snapshots, root_of_tree=True)
    else:
